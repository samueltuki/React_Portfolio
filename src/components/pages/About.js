        ...
        <div className="row m-4 my-auto align-items-center">
          ...
          <div className=" col-xs-12 col-md-6">
            ...
            <p className=" lead mt-3 h5 about-me-content">
              I have a keen eye for designing and creating beautiful and
              responsive websites. I do enjoy watching soccer and rap music.
            </p>

            <div>
              <Link to="/contact">
                <button className="btn btn-danger mt-5 mb-5">
                  Get In-touch
                </button>
              </Link>
            </div>
